...
class LiveRecord(models.Model):
    ...
    offline_gift_revenue = fields.FloatField(default=0)
    offline_guard_revenue = fields.FloatField(default=0)
    offline_sc_revenue = fields.FloatField(default=0)
    gift_revenue = fields.FloatField(default=0)
    guard_revenue = fields.FloatField(default=0)
    sc_revenue = fields.FloatField(default=0)
